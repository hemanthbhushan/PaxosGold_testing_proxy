...
contract PAXGImplementation2 {
    ...
    */
     ...
     */
     //in the propose owner the existing owner proposing the new owner 
     ...
     */
     //the proposed owner is removerd now only the owner got the rights
     ...
     */
     //the proposeowner is becoming the main owner 
    ...
    */
    ...
    function _betaDelegatedTransfer(
        ...
        //0x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF5D576E7357A4501DDFE92F46681B20A0 this might be the highest number in bytes as there are FFFFF and it is comparing it with the s as similar tolike checking for over flow in uint(-1);
        ...
        bytes32 hash = keccak256(abi.encodePacked(EIP191_HEADER, EIP712_DOMAIN_HASH, keccak256(abi.encodePacked(// solium-disable-line
                EIP712_DELEGATED_TRANSFER_SCHEMA_HASH, bytes32(uint256(uint160(to))), value, serviceFee, seq, deadline
        ))));
    ...
    */
    ...
    function setImproved(uint _x)public{
        improved = _x;
            }
}
